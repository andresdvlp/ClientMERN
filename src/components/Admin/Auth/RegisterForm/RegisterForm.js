...
export function RegisterForm(props) {
    ...
    const formik = useFormik({
        ...
        //formValue, son los datos que envia el usuario
    ...
    return (
        <Form className="register-form" onSubmit={formik.handleSubmit}>
            ...
            <Form.Checkbox name="conditionsAccepted"
                label="I have read and accept the privacy and data treatment policies"
                onChange={(_, data) => formik.setFieldValue("conditionsAccepted", data.checked)}
                checked={formik.values.conditionsAccepted}
                errorerror={formik.errors.conditionsAccepted}
            />
